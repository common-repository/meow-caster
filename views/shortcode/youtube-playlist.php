...
<?php else: ?>
	...
	<?php if ( ! $direct_embed ) { ?>
        <div class="mcss-embed-youtube" data-id="<?php echo $videoID; ?>" data-type="playlist"
             data-url="<?php echo $url . $param; ?>"></div>
	<?php } else { ?>
        <iframe class="mcss-reframe mcss-embed-direct" width="854" height="480"
                src="<?php echo $url . $param; ?>" frameborder="0" allow="encrypted-media" allowfullscreen></iframe>
	<?php }
endif;