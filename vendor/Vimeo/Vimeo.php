...
namespace MeowCaster_Vendor\Vimeo;

use MeowCaster_Vendor\Vimeo\Exceptions\VimeoRequestException;
use MeowCaster_Vendor\Vimeo\Exceptions\VimeoUploadException;
