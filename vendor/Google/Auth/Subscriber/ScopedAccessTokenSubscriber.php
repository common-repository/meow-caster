...
namespace MeowCaster_Vendor\Google\Auth\Subscriber;

use MeowCaster_Vendor\Google\Auth\CacheTrait;
use MeowCaster_Vendor\GuzzleHttp\Event\BeforeEvent;
use MeowCaster_Vendor\GuzzleHttp\Event\RequestEvents;
use MeowCaster_Vendor\GuzzleHttp\Event\SubscriberInterface;
...
class ScopedAccessTokenSubscriber implements SubscriberInterface {
	 ...
	 *   use MeowCaster_Vendor\Google\Auth\Subscriber\ScopedAccessTokenSubscriber;
	 ...
	 *       $scope,
	 *       ['prefix' => 'MeowCaster_Vendor\Google\Auth\ScopedAccessToken::'],
	 *       $cache = new Memcache()
	 *   );
	 *
	 *   $client = new Client([
