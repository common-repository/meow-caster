...
namespace MeowCaster_Vendor\Google\Auth\HttpHandler;

use Exception;
use MeowCaster_Vendor\GuzzleHttp\ClientInterface;
use MeowCaster_Vendor\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use MeowCaster_Vendor\GuzzleHttp\Promise\Promise;
use MeowCaster_Vendor\GuzzleHttp\Promise\RejectedPromise;
