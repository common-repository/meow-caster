...
namespace MeowCaster_Vendor\Google\Auth\Credentials;

use MeowCaster_Vendor\Google\Auth\CredentialsLoader;
use MeowCaster_Vendor\Google\Auth\HttpHandler\HttpHandlerFactory;
use MeowCaster_Vendor\GuzzleHttp\Exception\ClientException;
use MeowCaster_Vendor\GuzzleHttp\Exception\RequestException;
use MeowCaster_Vendor\GuzzleHttp\Exception\ServerException;
use MeowCaster_Vendor\GuzzleHttp\Psr7\Request;
 ...
 *
 *   use MeowCaster_Vendor\Google\Auth\Credentials\GCECredentials;
 *   use MeowCaster_Vendor\Google\Auth\Middleware\AuthTokenMiddleware;
 *   use MeowCaster_Vendor\GuzzleHttp\Client;
 *   use MeowCaster_Vendor\GuzzleHttp\HandlerStack;
 *
