...
class Google_Service_Analytics_Resource_ManagementRemarketingAudience extends Google_Service_Resource {
	 ...
	 *
	 * @param string                                       $accountId     The account ID for which to create the
	 ...
	 *
	 * @param string                                       $accountId             The account ID of the remarketing
	 *                                                                            audience to update.
	 * @param string                                       $webPropertyId         The web property ID of the
