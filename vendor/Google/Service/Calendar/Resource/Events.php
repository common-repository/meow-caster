...
class Google_Service_Calendar_Resource_Events extends Google_Service_Resource {
	 ...
	 *
	 * @param string                        $calendarId Calendar identifier. To retrieve calendar IDs call
	 *                                                  the calendarList.list method. If you want to access the primary
	 ...
	 *
	 * @param string                          $calendarId Calendar identifier. To retrieve calendar IDs call
	 *                                                    the calendarList.list method. If you want to access the
	 *                                                    primary calendar of the currently logged in user, use the
	 *                                                    "primary" keyword.
