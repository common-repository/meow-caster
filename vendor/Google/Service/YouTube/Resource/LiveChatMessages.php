...
class Google_Service_YouTube_Resource_LiveChatMessages extends Google_Service_Resource {
	 ...
	 *
	 * @param string                                 $part      The part parameter serves two purposes. It identifies
	 *                                                          the properties that the write operation will set as
	 *                                                          well as the properties that the API response will
