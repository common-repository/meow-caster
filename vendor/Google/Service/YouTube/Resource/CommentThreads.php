...
class Google_Service_YouTube_Resource_CommentThreads extends Google_Service_Resource {
	 ...
	 *                                                        response will include. Set the parameter value to
	 ...
	 *                                                        will include. You must at least include the snippet part
	 *                                                        in the parameter value since that part contains all of
