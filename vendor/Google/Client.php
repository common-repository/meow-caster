...
use MeowCaster_Vendor\Google\Auth\ApplicationDefaultCredentials;
use MeowCaster_Vendor\Google\Auth\Cache\MemoryCacheItemPool;
use MeowCaster_Vendor\Google\Auth\Credentials\ServiceAccountCredentials;
use MeowCaster_Vendor\Google\Auth\Credentials\UserRefreshCredentials;
use MeowCaster_Vendor\Google\Auth\CredentialsLoader;
use MeowCaster_Vendor\Google\Auth\HttpHandler\HttpHandlerFactory;
use MeowCaster_Vendor\Google\Auth\OAuth2;
use MeowCaster_Vendor\GuzzleHttp\Client;
use MeowCaster_Vendor\GuzzleHttp\ClientInterface;
use MeowCaster_Vendor\GuzzleHttp\Ring\Client\StreamHandler;
use MeowCaster_Vendor\Monolog\Handler\StreamHandler as MonologStreamHandler;
use MeowCaster_Vendor\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
use MeowCaster_Vendor\Monolog\Logger;
use MeowCaster_Vendor\Psr\Cache\CacheItemPoolInterface;
use MeowCaster_Vendor\Psr\Http\Message\RequestInterface;
use MeowCaster_Vendor\Psr\Log\LoggerInterface;
...
class Google_Client {
	...
	/**
	 * @var \MeowCaster_Vendor\Google\Auth\OAuth2 $auth
	 */
	private $auth;
	/**
	 * @var \MeowCaster_Vendor\GuzzleHttp\ClientInterface $http
	 */
	private $http;
	/**
	 * @var \MeowCaster_Vendor\Psr\Cache\CacheItemPoolInterface $cache
	 */
	private $cache;
	/**
	...
	private $config;
	/**
	 * @var \MeowCaster_Vendor\Psr\Log\LoggerInterface $logger
	 */
	private $logger;
	...
	/**
	 * @return \MeowCaster_Vendor\Google\Auth\OAuth2 implementation
	 */
	...
	/**
	 * @return \MeowCaster_Vendor\GuzzleHttp\ClientInterface implementation
	 */
	...
	/**
	 * @return \MeowCaster_Vendor\Psr\Log\LoggerInterface implementation
	 */
	 ...
	 *
	 * @param \MeowCaster_Vendor\Psr\Log\LoggerInterface $logger
	 */
	...
	/**
	 * @return \MeowCaster_Vendor\Psr\Cache\CacheItemPoolInterface Cache implementation
	 */
	 ...
	 *
	 * @param \MeowCaster_Vendor\Psr\Cache\CacheItemPoolInterface $cache
	 */
	 ...
	 *
	 * @param $request \MeowCaster_Vendor\Psr\Http\Message\RequestInterface|Google_Http_Batch
	 *
	 ...
	 *
	 * @param \MeowCaster_Vendor\GuzzleHttp\ClientInterface $http the http client object.
	 *
	 * @return \MeowCaster_Vendor\GuzzleHttp\ClientInterface the http client object
	 */
	...
	/**
	 * @return \MeowCaster_Vendor\Google\Auth\CacheInterface Cache implementation
	 */
	 ...
	 *
	 * @param \MeowCaster_Vendor\GuzzleHttp\ClientInterface $http
	 */
