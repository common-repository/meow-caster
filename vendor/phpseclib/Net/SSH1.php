...
use MeowCaster_Vendor\phpseclib\Crypt\DES;
...
class SSH1 {
	 ...
	 *
	 * Returns a string if NET_SSH1_LOGGING == self::LOG_COMPLEX, an array if NET_SSH1_LOGGING == self::LOG_SIMPLE and
	 * false if !defined('NET_SSH1_LOGGING')
	 *
	 * @access public
