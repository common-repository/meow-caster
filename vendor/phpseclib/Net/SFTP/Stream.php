...
namespace MeowCaster_Vendor\phpseclib\Net\SFTP;

use MeowCaster_Vendor\phpseclib\Crypt\RSA;
use MeowCaster_Vendor\phpseclib\Net\SFTP;
...
class Stream {
	 ...
	 * __call Magic Method
	 *
	 * When you're utilizing an SFTP stream you're not calling the methods in this class directly - PHP is calling them
	 * for you. Which kinda begs the question... what methods is PHP calling and what parameters is it passing to them?
	 * This function lets you figure that out.
	 *
	 * If NET_SFTP_STREAM_LOGGING is defined all calls will be output on the screen and then (regardless of whether or
	 * not NET_SFTP_STREAM_LOGGING is enabled) the parameters will be passed through to the appropriate method.
	 *
	 * @param string
	 * @param array
	 *
